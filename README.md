...
The purpose of this blog is to record little bits of insight — things that are small on their own, although they hold value. A blog is timely, fast, self-published, and the posts don't have to follow a grand idea or theme. There's lots of freedom in that. Maybe you'll find something of value.
